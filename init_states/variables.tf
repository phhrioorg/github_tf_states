...
variable "terraform_iam_policy_create" {
  description = "Specifies whether to create the terraform IAM policy."
  type        = bool
  default     = true
}
...
variable "kms_key_alias" {
  ...
  type        = string
  default     = "phhrioorg-tf-remote-state-key"
}

variable "kms_key_description" {
  description = "The description of the key as viewed in AWS console."
  type        = string
  default     = "The key used to encrypt the phhrioorg tf remote state bucket."
}
...
variable "state_bucket_prefix" {
  ...
  type        = string
  default     = "phhrioorg-tf-remote-state"
}
...
variable "iam_role_name_prefix" {
  description = "Creates a unique name beginning with the specified prefix."
  type        = string
  default     = "phhrioorg-tf-remote-state-replication-role"
}

variable "iam_policy_name_prefix" {
  description = "Creates a unique name beginning with the specified prefix."
  type        = string
  default     = "phhrioorg-tf-remote-state-replication-policy"
}

variable "iam_policy_attachment_name" {
  description = "The name of the attachment."
  type        = string
  default     = "phhrioorg-tf-iam-role-attachment-replication-configuration"
}
...
variable "dynamodb_table_name" {
  ...
  type        = string
  default     = "phhrioorg-tf-remote-state-lock"
}
